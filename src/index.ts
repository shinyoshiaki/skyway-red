...
function getRTCPeerConnection(connection: MediaConnection) {
...
export function activateRED(connection: MediaConnection) {
...
function senderTransform(sender: RTCRtpSender, redSender?: RedSender) {
  //@ts-ignore
